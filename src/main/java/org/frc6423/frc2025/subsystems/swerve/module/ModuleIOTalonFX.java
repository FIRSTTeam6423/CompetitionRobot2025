...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    // Signals
    private final BaseStatusSignal m_sigPivotABSPoseRots, m_sigPivotPoseRots, m_sigPivotVelRPM, m_sigPivotAppliedVolts, m_sigPivotSupplyCurrent, m_sigPivotTorqueCurrent;
    private final BaseStatusSignal m_sigDrivePoseRots, m_sigDriveVelRPM, m_sigDriveAppliedVolts, m_sigDriveSupplyCurrent, m_sigDriveTorqueCurrent;
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        inputs.pivotVelRadsPerSec = Units.rotationsPerMinuteToRadiansPerSecond(m_sigPivotVelRPM.getValueAsDouble());
        ...
        inputs.driveVelRadsPerSec = Units.rotationsPerMinuteToRadiansPerSecond(m_sigDriveVelRPM.getValueAsDouble());
