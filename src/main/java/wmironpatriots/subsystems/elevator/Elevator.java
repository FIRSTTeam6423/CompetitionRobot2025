...
public abstract class Elevator extends SubsystemBase implements Logged {
  ...
  public static final double POSE_L3 = 7.3; // (13.5 / 0.87835 / 3.14159 / 2 * 3); // 7;
  public static final double POSE_L4 = 12.75;

  public static final double POSE_ALGAE_HIGH = 9.7; // (10.5 / 0.87835 / 3.14159 / 2 * 3);
  public static final double POSE_ALGAE_LOW = 5.4; // (2.5 / 0.87835 / 3.14159 / 2 * 3);
