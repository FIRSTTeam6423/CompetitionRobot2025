...
public class ChassisVelocity {
   ...
   */
  public static ChassisVelocity fromRobotRelativeSpeeds(
      double vxMetersPerSec, double vyMetersPerSec, double omegaRadsPerSec) {
  ...
  /**
   * Creates a new chassis velocity from 3 field-relative speeds (where a positive x speed points
   * away from the alliance wall) to robot-relative speeds
   *
  ...
  public static ChassisVelocity fromFieldRelativeSpeeds(
      double vxMetersPerSec, double vyMetersPerSec, double omegaRadsPerSec, double headingRads) {
    return new ChassisVelocity(
  ...
  /**
   * Creates a {@link ChassisSpeeds} from the field-relative components of this {@link
   * ChassisVelocity}
   *
   * @param headingRads The angle between the positive x axis and the positive y axis of the chassis
   * @return
  ...
  public ChassisSpeeds getFieldRelative(double headingRads) {
    return ChassisSpeeds.fromRobotRelativeSpeeds(
        getRobotRelative(), Rotation2d.fromRadians(headingRads));
  }
